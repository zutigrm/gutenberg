...
class WP_Theme_JSON_Resolver_Gutenberg extends WP_Theme_JSON_Resolver_5_9 {
	...
	public static function get_theme_data( $deprecated = array() ) {
		...
		if ( null === static::$theme ) {
			...
			$theme_json_data = gutenberg_add_slug_to_fonts_registered_through_theme_json( $theme_json_data );
			...
			if ( wp_get_theme()->parent() ) {
				...
				$parent_theme_json_data = gutenberg_add_slug_to_fonts_registered_through_theme_json( $parent_theme_json_data );
